    ...
    return (
        <AuthenticatedLayout>
            ...
            <div className="flex items-center gap-3 mb-6 sm:mb-8">
                ...
                <div>
                    <h1 className="text-lg sm:text-2xl font-bold text-gray-900 tracking-tight">Tambah Ruangan Baru</h1>
                    <p className="text-[12px] text-gray-400 mt-0.5 hidden sm:block">Lengkapi informasi, fasilitas, dan foto ruangan</p>
                </div>
            </div>
                    ...
                    <div className="lg:col-span-8 space-y-5">
                        ...
                        <div className="bg-white rounded-xl border-2 border-gray-200 shadow-sm p-4 sm:p-6">
                            <div className="flex items-center gap-3 mb-5 pb-4 border-b border-gray-100">
                                ...
                                <div>
                                    <h2 className="text-[14px] font-semibold text-gray-800">Informasi Dasar</h2>
                            ...
                            <div className="mt-5 space-y-1.5">
                                <Label htmlFor="status" className="text-[12px] font-semibold text-gray-700">Status Awal</Label>
                                <div className="relative">
                                    <select
                                        id="status"
                                        value={data.status}
                            ...
                            >
                                {imagePreview ? (
                                    ...
                                    <div className="flex flex-col items-center text-center p-6">
                                        ...
                                        <p className="text-[13px] font-semibold text-gray-700">Upload Foto Utama</p>
